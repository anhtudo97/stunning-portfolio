      ...
      <div className="flex flex-col gap-20 mt-10 md:mt-20">
        {
          portfolioProjects.map(project => {
            return <div key={project.title} className="bg-gray-800 rounded-3xl relative z-0 overflow-hidden after:z-10 after:content-[''] after:absolute after:inset-0 after:outline-2 after:outline after:-outline-offset-2 after:rounded-3xl after:outline-white/20 after:pointer-events-none px-8 pt-8 md:pt-12 md:px-10 lg:pt-16 lg:px-20">
              <div
              ...
              <div className="lg:grid lg:grid-cols-2 lg:gap-16">
                ...
                <div className="lg:pb-16">
                  <div className="bg-gradient-to-r from-neutral-300 to-sky-400 inline-flex font-bold uppercase gap-2 tracking-widest text-sm text-transparent bg-clip-text">
